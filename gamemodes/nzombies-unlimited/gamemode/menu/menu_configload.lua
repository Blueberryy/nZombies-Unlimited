...
if CLIENT then
	...
	hook.Add("nzu_MenuCreated", "LoadConfig", function(menu)
		...
		sand2.DoClick = function()
			Derma_Query(translate.Get("are_you_sure"), translate.Get("mode_confirmation"), translate.Get("change_gamemode"), nzu.RequestEditConfig, "Cancel"):SetSkin("nZombies Unlimited")
		end
